        ...
        <div className="relative z-10 max-w-lg">
          ...
          <div className="bg-gradient-to-r from-yellow-500/10 to-yellow-600/10 border border-yellow-500/30 rounded-xl p-6 backdrop-blur-sm mb-10">
            ...
            <p className="text-sm text-gray-200 leading-relaxed mb-3">
              Built on patent-protected AI technology. SaintBroker™ automates your entire workflow 
              with enterprise-grade intelligence, 24/7 availability, and industry-leading security.
            </p>
